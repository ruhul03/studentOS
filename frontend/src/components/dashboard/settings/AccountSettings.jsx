...
export function AccountSettings({ user, accountInfo, setAccountInfo }) {
  return (
    <div className="space-y-8">
      <div className="flex items-center max-md:flex-col max-md:text-center gap-8 max-md:gap-4 pb-10 max-md:pb-6 border-b border-outline-variant/10">
        ...
        <div>
          ...
          <div className="mt-3 flex items-center max-md:justify-center gap-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-md:gap-4">
