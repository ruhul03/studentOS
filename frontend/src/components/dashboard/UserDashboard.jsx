  ...
  return (
    <div className="flex flex-col gap-10 w-full max-w-7xl mx-auto pb-16 animate-fade-in px-4 lg:px-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        {/* Daily Timeline */}
        <section className="lg:col-span-8 bg-surface-container border border-outline-variant rounded-2xl p-8 relative overflow-hidden group h-full">
        ...
        {/* Upcoming Events */}
        <section className="lg:col-span-4 bg-surface-container border border-outline-variant rounded-2xl p-8 h-full flex flex-col">
        ...
        {recentActivities.length > 0 ? (
          <section className="lg:col-span-4 bg-surface-container border border-outline-variant rounded-2xl p-8 h-full">
             <div className="flex justify-between items-center mb-6">
