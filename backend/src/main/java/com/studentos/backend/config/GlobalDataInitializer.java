        ...
        return args -> {
            ...
            if (userRepository.count() == 0) {
                User studentData = User.builder()
                        ...
                        .isVerified(true)
                        .build();
                User student = userRepository.save(studentData);
                
                User adminData = User.builder()
                        .name("Admin User")
                        .username("admin")
                ...
                if (eventRepository.count() == 0) {
                    CampusEvent event1 = CampusEvent.builder()
                    ...
                    CampusEvent event2 = CampusEvent.builder()
