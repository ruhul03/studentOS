...
public class AuthController {
    ...
    public ResponseEntity<?> loginUser(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        if (identifier.contains("@")) {
            userOptional = userRepository.findByEmailIgnoreCase(identifier);
        } else {
            userOptional = userRepository.findByUsernameIgnoreCase(identifier);
        }
    ...
    public ResponseEntity<?> forgotUsername(@Valid @RequestBody ForgotRequest request) {
        Optional<User> userOptional = userRepository.findByEmailIgnoreCase(request.getEmail().trim());
        if (userOptional.isPresent()) {
